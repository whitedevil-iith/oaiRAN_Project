...
void nr_ue_process_l1_measurements(NR_UE_MAC_INST_t *mac, frame_t frame, int slot, fapi_nr_l1_measurements_t *l1_measurements)
{
  ...
  if (!csi_meas && !l1_measurements->is_neighboring_cell) {
    mac->ssb_measurements.ssb_index = l1_measurements->ssb_index;
    mac->ssb_measurements.ssb_rsrp_dBm = l1_measurements->rsrp_dBm;
    mac->ssb_measurements.ssb_sinr_dB = l1_measurements->sinr_dB;
  }
